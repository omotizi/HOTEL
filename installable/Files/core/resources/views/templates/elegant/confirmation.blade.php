...
@section('content')
    ...
    @endphp
    <div class="confirmation-section mb-120">
        <div class="container">
            <div class="row justify-content-center gy-4">
                <div class="col-lg-8">
                    <div class="confirmation-container">
                        <div class="confirmation-container__shape">
                            <img src="{{ getImage($activeTemplateTrue . 'images/shapes/con-1.png') }}" alt="">
                        </div>
                        <div class="confirmation-container__wrapper">
                            <div class="confirmation-container__top">
                                ...
                                <div class="confirmation-container__top-content">
                                    <h3 class="confirmation-container__top-title">@lang('Congratulations')</h3>
                ...
                <div class="col-lg-4">
                    <div class="addon-sidebar">
                        <div class="addon-sidebar__top">
                            <h6 class="title">
                                @lang('Your Book Summery')
                            </h6>
                            <h6 class="text">
                                @lang('You Select'): {{ $bookingRequest->roomBookingRequest->count() }} @lang('Items')
                            </h6>
                        </div>
    ...
    @include('Template::sections.offer_section_two')
@endsection
