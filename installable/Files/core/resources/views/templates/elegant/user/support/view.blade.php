...
@section('content')
    ...
    <div class="container @guest mt-60 mb-120 @endguest">
        <div class="row justify-content-center">
            <div class="col-md-12">
                @guest
                    <div class="section-heading">
                        <h3 class="section-heading__title">{{ __($pageTitle) }} </h3>
                    </div>
                @endguest
                        ...
                        <form method="post" class="disableSubmission" action="{{ route('ticket.reply', $myTicket->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="row justify-content-between">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <p class="mb-3"><span class="text--info fs-14">@lang('Max 5 files can be uploaded | Maximum upload size is ' . convertToReadableSize(ini_get('upload_max_filesize')) . ' | Allowed File Extensions: .jpg, .jpeg, .png, .pdf, .doc, .docx')</span></p>
                                    <div class="row fileUploadsContainer">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <button class="btn btn--lg btn--base w-100 my-2" type="submit"><i class="la la-fw la-lg la-reply"></i> @lang('Reply')
                                    </button>
                                </div>
                    ...
                    <div class="card-body">
                        @forelse($messages as $message)
                            @if ($message->admin_id == 0)
                                <div class="row border border--base border-radius-8 my-3 py-3 mx-2">
                            ...
                            @else
                                <div class="row border border-warning border-radius-8 my-3 py-3 mx-2 reply-bg">
                                    <div class="col-md-3 border-end text-end">
                    ...
                    <div class="col-lg-6 col-md-12 removeFileInput">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <button type="button" class="input-group-text removeFile bg--danger px-3 border--danger text-white"><i class="fas fa-times"></i></button>
                            </div>
                        </div>
                    </div>
                `)
