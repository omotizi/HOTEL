            ...
            <div class="col-lg-12">
                <form action="{{ route('user.deposit.insert') }}" method="post" class="deposit-form disableSubmission">
                    ...
                    <div class="gateway-card">
                        <div class="row justify-content-center gy-sm-4 gy-4">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="payment-system-list p-3 gap-2or">
                                    <div class="deposit-info">
                                        ...
                                        <div class="deposit-info__input">
                                            <div class="deposit-info__input-group input-group">
                                                ...
                                                <input type="text" class="form-control form--control amount" name="amount" placeholder="@lang('00.00')" value="{{ old('amount', session()->get('amount')) }}" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <button type="submit" class="btn btn--lg btn--base w-100" disabled>
                                        @lang('Confirm Payment')
                                    </button>
                                    <div class="info-text">
                                        <span><i class="las la-info-circle"></i> @lang('Ensuring payment safely through our secure payment process with world-class payment options.')</span>
                                    </div>
                                </div>
                            </div>
                        </div>
