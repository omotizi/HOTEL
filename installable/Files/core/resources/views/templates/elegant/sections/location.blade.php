...
<div class="map-section mt-120">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading">
                    <h2 class="section-heading__title"> {{ __($locationContent?->data_values?->heading) }} </h2>
                    <p class="section-heading__desc"> {{ __($locationContent?->data_values?->subheading) }} </p>
                </div>
            </div>
        </div>
        <div class="contact-wrapper">
            <div class="row g-xl-4 g-md-3 g-2 justify-content-between">
                <div class="col-xl-4 col-sm-6">
                    <div class="contact-item">
                        ...
                        <div class="contact-item__info">
                            <h6 class="contact-item__title"> @lang('Telephone') </h6>
                            <p class="contact-item__desc">
                                <a href="tel:{{ $contactContent?->data_values?->email_address }}" class="link">
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="contact-item">
                        ...
                        <div class="contact-item__info">
                            <h6 class="contact-item__title"> @lang('Email') </h6>
                            <p class="contact-item__desc">
                                <a href="tel:{{ $contactContent?->data_values?->contact_number }}" class="link">
                                    {{ $contactContent?->data_values?->contact_number }} </a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-sm-12">
                    <div class="contact-item">
                        ...
                        <div class="contact-item__info">
                            <h6 class="contact-item__title"> @lang('Address') </h6>
                            <p class="contact-item__desc">
        ...
        <div class="location-map">
            <iframe src="{{ $locationContent?->data_values?->map_embed_link }}" width="600" height="450"
