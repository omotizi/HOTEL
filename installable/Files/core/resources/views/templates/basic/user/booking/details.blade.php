...
@section('content')
    ...
    @endphp
    <h5 class="text--secondary mb-3">@lang('Booked Rooms')</h5>
    ...
    @if ($booking->usedPremiumService->count())
        <h5 class="text--secondary mt-4 mb-3">@lang('Services')</h5>
        <div class="table-responsive--md">
    ...
    @if ($receivedPyaments->count())
        <h5 class="text--secondary mt-4 mb-3">@lang('Payments Recevied')</h5>
        <div class="table-responsive--md">
            <table class="custom--table head--base table">
                <thead>
                    <tr>
    ...
    @if ($returnedPyaments->count())
        <h5 class="text--secondary mt-4 mb-3">@lang('Payments Returned')</h5>
        <div class="table-responsive--md">
            <table class="custom--table head--base table">
                <thead>
                    <tr>
    ...
    <h5 class="text--secondary mt-4 mb-3">@lang('Payment Information')</h5>
