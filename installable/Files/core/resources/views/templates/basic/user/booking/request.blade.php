                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-end flex-wrap align-items-center gap-2">
                                <button class="btn btn-sm btn-outline--base detailBtn" data-resource="{{ json_encode($bookingRequest->roomBookingRequest) }}"><i class="las la-desktop"></i></button>
                                <button class="btn btn-sm btn-outline--danger confirmationBtn" data-action="{{ route('user.booking.request.cancel', $bookingRequest->id) }}" data-question="@lang('Are you sure to cancel this request?')"><i class="las la-times-circle"></i></button>
                            </div>
                        </td>
                    </tr>
                @empty
