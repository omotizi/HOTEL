...
<head>
    ...
    <link href="{{ asset('assets/global/css/all.min.css') }}?v=3" rel="stylesheet">
    ...
    <!-- main css -->
    <link href="{{ asset($activeTemplateTrue . 'css/main.css') }}?v=2" rel="stylesheet">
...
<body>
    ...
    <script>
        (function($) {
            ...
            $('#confirmationModal').find('.btn').addClass('btn-sm');
