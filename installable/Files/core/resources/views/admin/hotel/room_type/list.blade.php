                        ...
                        <table class="table--light style--two table">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('Room / Suite')</th>
                                    <th>@lang('Status')</th>
                                    @can(['admin.hotel.room.type.edit', 'admin.hotel.room.type.status', 'admin.hotel.room.index'])
                                        <th>@lang('Action')</th>
                                    @endcan
                                </tr>
                            </thead>
                            <tbody>
                                @forelse($typeList as $type)
                                    <tr>
                                        ...
                                        <td>
                                            @php echo $type->roomSuitesBadge @endphp
                                        </td>
                                        ...
                                        @can(['admin.hotel.room.type.edit', 'admin.hotel.room.type.status', 'admin.hotel.room.index'])
                                            <td>
                                                <div class="button--group">
                                                    @can('admin.hotel.room.index')
                                                    <a class="btn btn-sm btn-outline--primary" href="{{ route('admin.hotel.room.index', $type->id) }}"> <i class="las la-plus"></i>@lang('Rooms') ({{ $type->rooms_count }})
                                                    </a>
                                                    @endcan
