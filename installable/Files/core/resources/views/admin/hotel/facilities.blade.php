                        ...
                        <table class="table--light style--two table">
                            ...
                            <tbody>
                                @forelse($facilities as $item)
                                    @php
                                        $item->image_with_path = getImage(getFilePath('facility') . '/' . $item->image, getFileSize('facility'));
                                    @endphp
                                    <tr>
                                        <td>
                                            <div class="user">
        ...
        <div class="modal fade" id="cuModal" role="dialog" tabindex="-1">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.hotel.facility.save') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <x-image-uploader type="facility" class="w-100" :required="false" />
                            </div>
                        </div>
