...
@push('breadcrumb-plugins')
    ...
    @endcan
    @can('admin.request.booking.canceled.delete')
        @if ($bookingRequests->count())
            <button class="btn btn--base btn-outline--danger confirmationBtn" data-question="@lang('Are you sure to permanently delete all canceled booking requests?')" data-action="{{ route('admin.request.booking.canceled.delete') }}"><i class="las la-trash-alt"></i>@lang('Delete All')</button>
        @endif
    @endcan
@endpush
