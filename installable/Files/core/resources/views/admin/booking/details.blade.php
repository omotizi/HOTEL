...
@section('panel')
    ...
    <div class="row gy-4">
        @if (@$booking->booking_info->special_request)
        <div class="col-12">
                <div class="card bl--5 border--info">
                    <div class="card-body">
                        <h6><i class="fas fa-tags fa-flip-horizontal"></i> @lang('Spacial Request')</h6>
                        <p>{{ __(@$booking->booking_info->special_request) }}</p>
                    </div>
                </div>
            </div>
        @endif
                ...
                <div class="card-body">
                    <div class="d-flex flex-column gap-3">
                        ...
                        <div>
                            ...
                            <span class="d-block">{{ @$booking->booking_info->name }}</span>
                        </div>
                        @if(!blank($booking->guest))
                            <div>
                                <small class="fw-500"><i class="la la-user"></i> @lang('Other Guests')</small>
                                <span class="d-block">
                        ...
                        <div>
                            ...
                            <span class="d-block">{{ @$booking->booking_info->email }}</span>
                        </div>
                        <div>
                            <small class="fw-500"><i class="la la-mobile"></i> @lang('Mobile')</small>
                            <span class="d-block">
                                +{{ @$booking->booking_info->mobile }}
                            </span>
                        </div>
                    ...
                    <div class="d-flex flex-wrap justify-content-between gap-3">
                        ...
                        <div class="d-flex flex-column gap-3">
                            ...
                            <div>
                                ...
                                <small><em>{{ showDateTime($booking->check_in, 'd M, Y') }}</em> <em>{{ showDateTime(@$booking->booking_info->arrival,'h:i A') }}</em></small>

                            </div>

                            <div>
                                <small class="fw-500">@lang('Checkout')</small> <br>
                                <small><em>{{ showDateTime($booking->check_out, 'd M, Y') }}</em> <em>{{ showDateTime(@$booking->booking_info->departure,'h:i A') }}</em></small>
                            </div>
                    ...
                    <div aria-labelledby="summaryHeading" class="accordion-collapse collapse show" data-bs-parent="#s" id="summaryBody">
                        <div class="accordion-body p-0">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="d-flex justify-content-between list-group-item align-items-start">
                                    <span>@lang('Coupon Discount') @if($booking->coupon) - {{ $booking->coupon->coupon_code }} @endif</span>
                                    <span> -{{ showAmount($booking->coupon_amount) }}</span>
                                </li>
                                <li class="d-flex justify-content-between list-group-item align-items-start">
