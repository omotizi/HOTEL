...
Route::middleware('admin', 'adminPermission')->group(function () {
    Route::controller('AdminController')->group(function () {
        ...
        Route::post('request-report-submit', 'reportSubmit')->name('request.report.submit');
    ...
    Route::name('hotel.')->prefix('hotel')->group(function () {
        ...
        Route::controller('RoomTypeController')->name('room.type.')->prefix('room-type')->group(function () {
            ...
            Route::get('collection', 'roomType')->name('collection');
        });

        //Room
        Route::controller('RoomController')->name('room.')->prefix('room')->group(function () {
            Route::get('{suiteTypeId}', 'index')->name('index');
            Route::post('add/{roomTypeId}', 'addRoom')->name('add');
            Route::post('update/{roomTypeId}/{id}', 'addRoom')->name('update');
            Route::post('status/{id}', 'status')->name('status');
        });
    ...
    Route::controller('BookRoomController')->group(function () {
        ...
        Route::post('room-books', 'book')->name('room.book');
        ...
        Route::post('room/apply-coupon', 'applyCoupon')->name('room.apply.coupon');
        Route::post('room/remove-coupon', 'removeCoupon')->name('room.remove.coupon');
    });
    ...
    Route::controller('ManageBookingRequestController')->prefix('booking')->name('request.booking.')->group(function () {
        ...
        Route::post('delete/all', 'deleteAll')->name('canceled.delete');
    ...
    Route::controller('CouponController')->prefix('promotion/coupon')->name('coupon.')->group(function () {
        ...
        Route::get('room-type', 'roomTypeForCoupon')->name('room.type');
        Route::get('applied-coupon/{id}', 'appliedCoupon')->name('applied');
        Route::post('status/{id}', 'status')->name('status.change');
    });
    ...
    Route::controller('OfferController')->prefix('promotion/offer')->name('offer.')->group(function () {
        ...
        Route::get('edit/{id}', 'edit')->name('edit');
        Route::post('save/  {id}', 'save')->name('store');
        Route::get('room-type', 'roomTypeForOffer')->name('room.types');
        Route::post('status/{id}', 'status')->name('status');
    });
