    ...
    Route::middleware(['check.status', 'registration.complete'])->group(function () {
        ...
        Route::namespace('User')->group(function () {
            ...
            Route::controller('ProfileController')->group(function () {
                ...
                Route::post('profile-setting', 'submitProfile')->name('submit.profile.setting');
                Route::get('change-password', 'changePassword')->name('change.password');
                Route::post('change-password', 'submitPassword')->name('submit.change.password');
            });
            ...
            Route::controller('BookingController')->prefix('booking')->name('booking.')->group(function () {
                ...
                Route::get('all', 'allBookings')->name('all');
                Route::get('payment/{id}', 'payment')->name('payment');
                Route::get('details/{booking_number}', 'bookingDetails')->name('details');
