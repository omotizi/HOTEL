...
function filterAndExtractIds($array)
{
...
function countAvailableRooms($roomType, $checkin, $checkout)
{
    $bookedRooms = $roomType->bookedRooms()->whereBetween('booked_for', [$checkin, $checkout])->pluck('room_id')->toArray();
    $availableRooms = $roomType->activeRooms()->whereNotIn('id', $bookedRooms)->count();
