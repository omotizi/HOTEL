...
class SectionHeadingController extends Controller
{
   ...
   public function updateRoomCategorySection(Request $request, $language)
  {
   ...
   public function roomLatestSection(Request $request)
    {
      $language = Language::where('code', $request->language)->first();
      $information['language'] = $language;
      ...
      return view('backend.home_page.room_latest_section', $information);
    }

   public function updateRoomLatestSection(Request $request, $language)
  {
    $rules = [
      'latest_room_section_title' => 'required',
    ];
  ...
  public function packageCategorySection(Request $request)
    {
      $language = Language::where('code', $request->language)->first();
      $information['language'] = $language;
      ...
      return view('backend.home_page.package_category_section', $information);
    }

   public function updatePackageCategorySection(Request $request, $language)
  {
    $rules = [
      'package_feature_category_title' => 'required',
    ];
  ...
  public function packageLatestSection(Request $request)
    {
      $language = Language::where('code', $request->language)->first();
      $information['language'] = $language;
      ...
      return view('backend.home_page.package_latest_section', $information);
    }

   public function updatePackageLatestSection(Request $request, $language)
  {
    $rules = [
      'latest_package_section_title' => 'required',
    ];
  ...
  public function updateFacilitySection(Request $request, $language)
  {
    ...
    if ($data == null) {
      if ($request->filled('facility_section_image')) {
        ...
        copy(public_path($facilitySecImgURL), $directory . $facilityImgName);
      }
  ...
  public function updateTestimonialSection(Request $request, $language)
  {
    ...
    if ($data == null) {
      ...
      copy(public_path($testimonialSecImgURL), $directory . $testimonialImgName);
      ...
      if ($request->filled('testimonial_section_image')) {
        ...
        if (
          !is_null($data->testimonial_section_image) &&
          file_exists(public_path('assets/img/testimonial_section/') . $data->testimonial_section_image)
        ) {
  ...
  public function updateFAQSection(Request $request, $language)
  {
    ...
    if ($data == null) {
      ...
      copy(public_path($faqSecImgURL), $directory . $faqImgName);
      ...
      if ($request->filled('faq_section_image')) {
        ...
        if (
          !empty($data->faq_section_image) &&
          file_exists(public_path('assets/img/faq_section/') . $data->faq_section_image)
        ) {
          unlink(public_path('assets/img/faq_section/') . $data->faq_section_image);
        }
