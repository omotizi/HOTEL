  ...
  public function update(LanguageUpdateRequest $request)
  {
    ...
    if ($language->code !== $request->code) {
      ...
      if (file_exists(lang_path($language->code . '.json'))) {
        if (is_file(lang_path($language->code . '.json'))) {
            ...
            if ($otherPcs == 0) {
              ...
              if (!empty($package->slider_imgs) && $package->slider_imgs != '[]') {
                ...
                foreach ($sliders as $key => $slider) {
                  @unlink(public_path('assets/img/packages/slider_images/') . $slider);
                }
              }
          ...
          foreach ($roomContents->get() as $rc) {
            ...
            if ($otherRcs == 0) {
              ...
              if (!empty($room->slider_imgs) && $room->slider_imgs != '[]') {
                ...
                foreach ($sliders as $key => $slider) {
                  @unlink(public_path('assets/img/rooms/slider_images/') . $slider);
                }
              }
