        ...
        >
          ...
          <div class="form-group">
            <div class="thumb-preview" id="thumbPreview2">
              <img src="" alt="category image" class="featured-img">
            </div>
            <br><br>

            <input type="hidden" id="fileInput2" name="featured_img">
            <button
              id="chooseImage2"
            ...
            <p id="editErr_featured_img" class="mt-2 mb-0 text-danger em"></p>
          </div>
          {{-- featured image end --}}
          @endif
